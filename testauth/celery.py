...
No app in this project defines tasks, but Alliance Auth's own system checks
(B003/B004) assert that the Celery app is configured the way a real deployment
configures it, and those checks run before the test suite does.
"""
